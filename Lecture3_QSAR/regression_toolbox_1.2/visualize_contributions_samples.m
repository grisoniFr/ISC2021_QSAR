...
% uipanel
set(handles.myuipanel,'Position',[3.5 28 30 15]);
...
if get(handles.pop_yaxis,'Value') == 2
    line([0.5 length(inplot_T2)+0.5],[-1 -1],'Color','r','LineStyle',':','LineWidth',1)
    line([0.5 length(inplot_T2)+0.5],[1 1],'Color','r','LineStyle',':','LineWidth',1)
end
title(title_list{2})
box on
...
if get(handles.pop_yaxis,'Value') == 2
    line([0.5 length(inplot_Qres)+0.5],[-1 -1],'Color','r','LineStyle',':','LineWidth',1)
    line([0.5 length(inplot_Qres)+0.5],[1 1],'Color','r','LineStyle',':','LineWidth',1)
end
title(title_list{3})
box on
