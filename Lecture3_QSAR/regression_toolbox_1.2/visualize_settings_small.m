...
handles.num_variables = varargin{3};
handles.model_is_present = varargin{4};
model_loaded = varargin{5};
...
set(handles.button_help,'Position',[x_position_button 7 23 2]);
set(handles.button_cancel,'Position',[x_position_button 10 23 2]);
set(handles.button_calculate_model,'Position',[x_position_button 13 23 2]);
...
if handles.num_samples < handles.num_variables && strcmp(handles.model_type,'ols')
    set(handles.button_calculate_model,'Enable','off');
else
    set(handles.button_calculate_model,'Enable','on');
end

% ------------------------------------------------------------------------
function handles = custom_form(handles)
set(handles.visualize_settings_small,'Name','OLS settings')
