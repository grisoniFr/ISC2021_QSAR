function res = simcacompsel(X,class,target_class,pret_type,cv_type,cv_groups)

% selection of the optimal number of components for SIMCA by means of cross-validation
%
% res = simcacompsel(X,class,target_class,pret_type,cv_type,cv_groups)
%
% INPUT:
...
for k = 1:r
    ...
    elseif getappdata(hwait,'canceling')
        ...
        waitbar(k/r)
        num_comp = k;
        out = simcacv(X,class,target_class,num_comp,pret_type,cv_type,cv_groups);
